...
This module defines a custom HTTP 410 response class for handling
HTTP 410 errors in a Django application. It extends the BaseErrorResponse
class for structured error handling and logging.

Usage:
------
Use this custom response class to return a 410 response with
...
class Http410Response(BaseErrorResponse):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        Initialize the Http410Response.
